...
router.get(
  "/dashboard/edit-modal/fetch-data",
  dashboardController.fetchPlayerData
);
...
router.get(
  "/store-items",
  authController.isLoggedIn,
  storeItemsController.loadStoreItems
);
router.get(
  "/store-items/fetch-store-items-details",
  storeItemsController.fetchStoreItemsDetail
);
router.get("/store-items/fetch-discount", storeItemsController.fetchDiscount);
router.get(
  "/store-items/edit-modal/fetch-data",
  storeItemsController.fetchItemData
);
...
router.delete(
  "/store-items/delete-store-item",
  storeItemsController.deleteStoreItem
);

router.get(
  "/memberships",
  authController.isLoggedIn,
  membershipsController.loadMemberships
);
router.get(
  "/memberships/fetch-privilege-class",
  membershipsController.fetchPrivilegeClass
);
router.get(
  "/memberships/edit-modal/fetch-data",
  membershipsController.fetchMembershipData
);
router.get(
  "/memberships/create-modal/check-membership",
  membershipsController.checkMembershipExistence
);
...
router.delete("/events/drop-all-events", eventsController.dropAllEvents);
...
router.get(
  "/matches/fetch-match-basic-info",
  matchesController.fetchMatchBasicInfo
);
router.get(
  "/matches/fetch-match-players-info",
  matchesController.fetchMatchPlayersInfo
);
